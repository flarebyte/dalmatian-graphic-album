...
func (rcv *Section) SupplementId() uint16 {
...
func (rcv *Section) MutateSupplementId(n uint16) bool {
...
func SectionAddSupplementId(builder *flatbuffers.Builder, supplementId uint16) {
