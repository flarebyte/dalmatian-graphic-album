...
export class TripleValue {
   ...
   * @returns TripleValue
   */
  static getRootAsTripleValue(
    bb: flatbuffers.ByteBuffer,
    obj?: TripleValue
  ): TripleValue {
    return (obj || new TripleValue()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }
  ...
  static addSubject(
    builder: flatbuffers.Builder,
    subjectOffset: flatbuffers.Offset
  ) {
...
export class Script {
   ...
   * @returns TripleValue
   */
  metadata(index: number, obj?: TripleValue): TripleValue | null {
    var offset = this.bb!.__offset(this.bb_pos, 4);
    return offset
      ? (obj || new TripleValue()).__init(
          this.bb!.__indirect(
            this.bb!.__vector(this.bb_pos + offset) + index * 4
          ),
          this.bb!
